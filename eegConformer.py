...
Based on the following information, write a medical report explaining how the EEG findings relate to the patient's age.

{report_header}

Provide an interpretation of the EEG activity in the top channels, including the relative band powers (Delta, Theta, Alpha, Beta, Gamma), and discuss how it correlates with the patient's age. Explain any possible reasons for the discrepancy between the predicted and actual age. Focus on the EEG patterns typically associated with the patient's age group. Keep the report professional and avoid mentioning any machine learning models or algorithms.
...
print("Reports generated in the 'reports_spec' directory.")
